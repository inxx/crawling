...
## HTTP GET Request
req = requests.get('http://kor.lottedfs.com/kr/display/category/first?dispShopNo1=1100001&treDpth=1')
...
for title in my_titles:
    ...
    price_usd = title.find_all('div', class_='discount')
    price_krw = title.find_all('span', class_='nation-currency')
    #print(price_usd[0].text + price_krw[0].text)
    data[title.get('data-gaevtlabel')] = price_usd[0].text + price_krw[0].text
